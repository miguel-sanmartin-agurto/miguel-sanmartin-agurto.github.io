          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              {edu.achievements && edu.achievements.length > 0 && (
                <motion.div
                  className="mt-3 p-4 bg-background/80 backdrop-blur-sm backdrop-filter rounded-lg border border-emerald-500/10 dark:bg-card/10 dark:border-emerald-500/10 shadow-sm"
